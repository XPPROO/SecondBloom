...
`Что то там еще, будет дополняться`
...
2. **Создайте `.env` файл**:  
   ...
   - Для `DJANGO_SECRET_KEY` сгенерируйте новый: `python -c "import secrets; print(secrets.token_urlsafe(50))"`
3. **Настройте базу данных**: Создайте PostgreSQL БД и заполните параметры в `.env`.
4. **Примените миграции**: `python manage.py migrate`
5. **Запустите сервер**: `python manage.py runserver`

**Важно**: Никогда не коммитьте `.env` в Git - он содержит секреты.
